              ...
              <div className="card w-full md:p-12 card-body px-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className=" space-y-5">
                  ...
                  <div className="form-control">
                    <input
                      ...
                      className="file-input rounded file-input-bordered file-input-accent w-full"
                    />
                    {errors.image && (
                  ...
                  <div className="form-control">
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-5 bottom-2 text-my-primary"
                      >
                        {showPassword ? (
                  ...
                  <div className="form-control mt-6">
                    <button
                      type="submit"
                      className="login-btn w-full mx-auto form-control mt-2 tracking-widest"
                    >
                      {loading ? (
                        <TbFidgetSpinner className="text-3xl animate-spin" />
                      ) : (
                        "Register"
                      )}
                    </button>
                ...
                <div className="mt-2 ">
                  <p className="inline-flex items-center">
                    ...
                    <Link
                      to="/login"
                      className="text-sm underline font-semibold ml-2 md:hover:text-my-primary hover:text-white transition duration-300"
                    >
                      Login
                    </Link>
                  </p>
